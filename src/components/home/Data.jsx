  ...
  return (
    <div className='w-[70%] md:w-1/2 ml-10'>
      ...
      <h3 className='flex text-base text-textPrimary font-normal mb-5 mt-5 md:text-sm md:mt-3 md:mb-3 lg:text-base lg:mb-5 lg:mt-5'><span className='flex mt-3 w-14 mr-3 h-[1px] font-normal bg-zinc-500'></span>
        Web Programmer</h3>
      <p className='text-sm font-normal text-zinc-500 mb-8'>"Bachelor of Informatics Engineering. Hardworking and collaboration"</p>

      <a href='#contact' className='flex max-w-fit text-base font-semibold text-zinc-50 bg-textPrimary py-3 px-8 rounded-lg hover:bg-hoverTextPrimary'>
        Contact
